function Detail(ID, IdReceipt, IdProduct, Name, IdCategory, PriceInput, PriceOutput, Quantity) {
    this.ID = ID + 1;
...
btnCreateImporter.addEventListener('click', (e) => {
    ...
    btnSubmit.addEventListener('click', (e,) => {
        ...
        if (valuePlacementReceipt == "" || valueQuantityReceipt == "") {
            ...
            let temp = new Detail(position, valueIdReceipt, ProductList[valuePlacementReceipt - 1].ID, ProductList[valuePlacementReceipt - 1].Name, ProductList[valuePlacementReceipt - 1].IdCategory, ProductList[valuePlacementReceipt - 1].PriceInput, ProductList[valuePlacementReceipt - 1].PriceOutput, valueQuantityReceipt)
...
function ReceiptDetailTable(position) {
    ...
    table.innerHTML += tr.innerHTML = `
            ...
            <td>${arrProduct[position].IdCategory} </td>
